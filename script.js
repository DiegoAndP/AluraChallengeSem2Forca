...
function detectaVitoria() {
    ...
    if (tabelaVitoria.every(e => e === true) && (palavrasErradas.length > 0)) { //Condição acertos é uma gambiarra para evitar que a primeira palavra errada retorner a mensagem de vitória
